...
<head>
	...
	<link href="css/back/loginstyle.css" rel="stylesheet" type="text/css" media="all" />
...
<body onload="createCode()">
		...
		<div class="login-top">
			...
			<form>
				<input id="myUserName" type="text" placeholder="用户名"
					...
					style="float: left; width: 130px;" placeholder="验证码" type="text"
	...
	<div class="loginbm">© 2017 雪山爱好网.版权所有 | 设计人： <a href="#"> 王天赐 </div>
</body>
</html>