...
<head>
	...
	<link href="css/back-personalCenter.css" rel="stylesheet" type="text/css" media="all" />
	<script type="text/javascript" src="js/back/personalCenter.js" charset="UTF-8"></script>
</head>
<body>
	<input type="hidden" id="elPersonDicId" value="${myperson.dicId}">
	<input type="hidden" id="elPersonGender" value="${myperson.gender}">
	<input type="hidden" id="elPersonId" value="${myperson.presonId}">
	<input type="hidden" id="elAttUpdateID" value="${myperson.attid}">
	<input type="hidden" id="elPersonAtturl" value="${myperson.atturl}">
	<input type="hidden" id="elPersonAttname" value="${myperson.attname}">
