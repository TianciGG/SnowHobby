			...
			<nav class="navbar navbar-default agilehovereffect wthreehovereffect">
				<div class="navbar-header navbar-left">
					<div class="w3_navigation_pos">
						<a href="user/toIndex.do"> <img src="images/logo.png" alt="雪山爱好网">
							<h1>雪山爱好</h1>
						</a>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<nav class="link-effect-2" id="link-effect-2">
						<ul class="nav navbar-nav">
							<li><a class="scroll" href="user/toIndex.do"><span>首页</span></a>
							</li>
							<li><a class="scroll" href="goToForumPage.do"><span>爱好交流</span></a>
							</li>
							<li><a class="scroll" href="team/toTeamTrip.do"><span>旅行交友</span></a>
							</li>
							<li><a class="scroll" href="goToMallPage.do"><span>商城购物</span></a>
							</li>
							<li><a class="scroll" href="person/toPersonal.do"><span>个人中心</span></a>
							</li>
				...
				<div class="item w3-agile">
					<div class="agilegrid agilegrid1">
						...
						<div class="sign w3-agile text-center">
							<a class="popup-with-zoom-anim" href="goToMallPage.do">BOOK NOW</a>
						</div>
					</div>
				</div>
				<div class="item w3-agile">
					<div class="agilegrid agilegrid2">
						...
						<div class="sign w3-agile text-center">
							<a class="popup-with-zoom-anim" href="goToMallPage.do">BUY NOW</a>
						</div>
					</div>
				</div>
				<div class="item w3-agile">
	...
	<div class="w3portfolioaits" id="w3portfolioaits">
		...
		<div class="w3portfolioaits-items">
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-1">
				<a class="example-image-link" href="team/toTeamTrip.do">
					<div class="grid">
				...
				<div class="col-md-4 agilefooterwthree-grid agilefooterwthree-grid2">
					...
					<address>
						<ul>
							...
							<li>东四十条甲22号A座</li>
							<li>北京市长亮新融科技有限公司</li>
							<li><a class="mail" href="user/toIndex.do">wangtianci@sunline.cn</a></li>
						</ul>
					</address>
				</div>
				<div
