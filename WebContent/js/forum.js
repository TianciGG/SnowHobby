	...
	if(typeof smilies_type == 'object') {
		...
		if(seditorkey == 'fastpost' && $('fastsmilies') && smilies_fast) {
			...
			for(i = 0;i < smilies_fast.length; i++) {
				...
				smilieimg ='http://static.8264.com/static/image/smiley/' + smilies_type[smilies_fast[i][0]][1] + '/' + s[2];
				img[k] = new Image();
				img[k].src = smilieimg;
...
function smilies_switch(id, smcols, type, page, seditorkey) {
	...
	for(i in smilies_array[type][page]) {
		...
		smilieimg ='http://static.8264.com/static/image/smiley/' + smilies_type[type][1] + '/' + s[2];
		img[k] = new Image();
		img[k].src = smilieimg;
...
function extstyle(css) {
	...
	$('css_extstyle').href = css ? css + '/style.css' : 'http://static.8264.com/static/image/common/extstyle_none.css';
	currentextstyle = css;
