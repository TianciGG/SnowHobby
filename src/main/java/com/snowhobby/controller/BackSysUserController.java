...
public class BackSysUserController {
	...
	@ResponseBody
	public void addSysUser(SysUser sysUser, BackPerson person,
	...
	@ResponseBody
	public List<UserManage> getAllSysUser(SysUser sysUser,
			HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		response.setCharacterEncoding("UTF-8");
		return sysUserService.selectUserPerson(sysUser.getUserName());
	}
	...
	@ResponseBody
	public void checkOriginalPwd(SysUser sysUser, HttpServletRequest request,
